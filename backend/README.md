...
## Project Structure
    ...
    ├── testapiautoconnecto_59684  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_59684`
...
2. Clone this repo and `cd testapiautoconnecto_59684`
